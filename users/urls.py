...
from .views import TrainerListView, TrainerDetailView, AdminListView, AdminUserListView, \
    AdminSubscriptionListView, AdminSubscriptionUpdateView, ClientListView
...
urlpatterns = [
    ...
    path("/api/v1/admin/subscriptions/", AdminSubscriptionListView.as_view(),
         name="admin-subscriptions"),
    path("/api/v1/admin/subscriptions/<int:id>/", AdminSubscriptionUpdateView.as_view(),
