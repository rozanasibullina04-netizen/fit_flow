...
from .views import AdminStatsOverviewView, ClientDetailView
...
urlpatterns = [
    ...
    path('api/v1/client/<int:id>/', ClientDetailView.as_view(), name='client-detail'),
    path('api/v1/admin/stats/', AdminStatsOverviewView.as_view(), name='admin-stats'),
]
